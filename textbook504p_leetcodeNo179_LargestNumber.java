...
*
* 큰 수를 int타입으롤 전부 처리할 수는 없기 때문에 일단 스트링 타입으로 처리해야 한다는 것에 대해서 이해하는 것은 큰 무리가 없었을 거라 생각됩니다. int 타입이 저장 가능한 숫자의 최댓값은 약 9억 몇 천만 정도 밖에 되지 않는데, 문제에서 만들어질 수 있는 숫자는 이를 훨씬 초과하는 경우가 분명 존재할 것이기 때문입니다.
*
